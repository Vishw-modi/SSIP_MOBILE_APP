...
//   },
// };
// Light theme palette - Modern Nutrition App
const lightPalette = {
  primary: "#00C853", // Vibrant health green
  primaryLight: "#69F0AE",
  primaryDark: "#00A93F",
  primaryBg: "#E8F5E8",
  primaryBorder: "#C8E6C9",

  accent: "#FF6B35", // Fresh orange accent
  accentLight: "#FF8A65",
  accentDark: "#E64A19",
  accentBg: "#FFF3E0",

  // Backgrounds - Clean, fresh whites and off-whites
  bg: "#FAFAFA", // Soft warm white
  bgSecondary: "#F5F5F5", // Light gray
  bgTertiary: "#FFFFFF", // Pure white
  ...
  textMuted: "#757575", // Light gray
  textDisabled: "#BDBDBD",
  textInverse: "#FFFFFF",

  // Borders and dividers - Subtle and clean
  border: "#E0E0E0",
  borderLight: "#F0F0F0",
  borderStrong: "#CCCCCC",
  divider: "#E0E0E0",
  ...
  pressed: "rgba(0, 200, 83, 0.12)",
  focus: "rgba(0, 200, 83, 0.16)",
  disabled: "rgba(189, 189, 189, 0.5)",
...
// Dark theme palette - Modern Nutrition App
const darkPalette = {
  primary: "#4CAF50", // Softer green for dark mode
  primaryLight: "#81C784",
  primaryDark: "#388E3C",
  primaryBg: "#1B2A1B", // Deep forest green
  ...
  // Backgrounds - Rich, modern dark tones
  bg: "#0D1117", // Deep charcoal (GitHub-inspired)
  bgSecondary: "#161B22", // Slightly lighter
  bgTertiary: "#21262D", // Card background

  // Cards and surfaces
  card: "#21262D",
  cardSecondary: "#161B22",
  cardElevated: "#2D3748",
  actionBar: "#161B22",

  // Text - High contrast for dark mode
  text: "#F0F6FC", // Soft white
  textSecondary: "#C9D1D9", // Light gray
  ...
  // Interactive states
  hover: "rgba(76, 175, 80, 0.12)",
  pressed: "rgba(76, 175, 80, 0.16)",
  focus: "rgba(76, 175, 80, 0.20)",
  ...
  danger: "#F44336",
  dangerBg: "rgba(244, 67, 54, 0.15)",
  dangerText: "#EF5350",

  info: "#2196F3",
  infoBg: "rgba(33, 150, 243, 0.15)",
  infoText: "#64B5F6",
};
